...
export interface IBrimboriumMessageFlowClient {
    /**
     * @return OK
     */
...
export class BrimboriumMessageFlowClient implements IBrimboriumMessageFlowClient {
    ...
    getListMessageFlowName(httpContext?: HttpContext): Observable<SwaggerResponse<string[]>> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListMessageFlowName(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListMessageFlowName(response_ as any);
                } catch (e) {
    ...
    getMessageFlowGraph(name: string, httpContext?: HttpContext): Observable<SwaggerResponse<MessageFlowGraph>> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMessageFlowGraph(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMessageFlowGraph(response_ as any);
                } catch (e) {
